  ...
  return (
    <div className="p-2 justify-around">
      ...
      <div className="details-div py-6 flex flex-col items-center space-y-4">
        <Link to="/profilePage" className="w-11/12 rounded-xl py-1 h-[50px]">
        ...
        <Link to="/availableEvents" className="w-11/12 rounded-xl py-1 h-[50px]">
          <button className="w-full h-full rounded-xl bg-black text-white font-bold py-2 hover:bg-gray-200 hover:text-black active:bg-green-400">
            Available Events
          </button>
        </Link>
        <Link to="/bookedEvents" className="w-11/12 rounded-xl py-1 h-[50px]">
          <button className="w-full h-full rounded-xl bg-black text-white font-bold py-2 hover:bg-gray-200 hover:text-black active:bg-green-400">
            Booked Events
          </button>
        </Link>
